...
import { ClockIcon, CalendarIcon, CheckCircle2, XCircle } from 'lucide-react';
                                            ...
                                            <CardHeader className='p-4'>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-smtext-muted-foreground">{interview.title}</p>
                                                    </div>
                                                </div>
                                            </CardHeader>
                                            ...
                                            <CardFooter className="p-4 pt-0 flex flex-col gap-3">
                                                {interview.status === "completed" && (
                                                    <div className="flex gap-2 w-full">
                                                        <Button className="flex-1" onClick={() => handleUpdateStatus(interview._id, "succeeded")}>
